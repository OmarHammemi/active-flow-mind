...
const supabaseAnonKey = import.meta.env.VITE_SUPABASE_ANON_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImppaGJ2c2pneHpvdnlza21nZmdyIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzA0NDY5NTEsImV4cCI6MjA4NjAyMjk1MX0.oVZMKL_Tt9lEC7yTNBalnqW3l4-JiKktjtbBE-kCxAw';
...
export const supabase = createClient(supabaseUrl, supabaseAnonKey, {
  auth: {
    ...
    storageKey: 'sb-jihbvsjgxzovyskmgfgr-auth-token',
  },
  global: {
    headers: {
      'Accept': 'application/json',
      'Content-Type': 'application/json',
      // Don't add apikey here - Supabase adds it automatically
    },
  },
});
